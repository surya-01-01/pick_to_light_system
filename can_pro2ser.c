 ...
 * Author: surya
 *
 * Created on 8 May, 2025, 11:49 AM
 */
...
extern unsigned char pid2[5],ust2[5]; 
...
void can_transmit(void)
{
	...
	TXB0D0 = pid2[0];			/* DataByte 0 */
	TXB0D1 = pid2[1];			/* DataByte 1 */
	TXB0D2 = pid2[2];			/* DataByte 2 */
	TXB0D3 = pid2[3];			/* DataByte 3 */
	TXB0D4 = ust2[0];			/* DataByte 4 */
	TXB0D5 = ust2[1];			/* DataByte 5 */
	TXB0D6 = ust2[2];			/* DataByte 6 */
	TXB0D7 = ust2[3];			/* DataByte 7 */
